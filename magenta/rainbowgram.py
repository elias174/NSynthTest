...
def note_specgram(f, ax, peak=70.0, use_cqt=True, path=''):
    ...
    if use_cqt:
        ...
        C = librosa.stft(audio, n_fft=n_fft, win_length=n_fft,
...
plot_notes(['keyboard_acoustic_004-058-127.wav','gen_keyboard_acoustic_004-058-127.wav'],)